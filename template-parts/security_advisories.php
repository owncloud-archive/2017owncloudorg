 ...
 ?>
    <div class="col-md-4">
     <h2><?php echo $advisory_platform->name; ?></h2>
       ...
       <a class="btn btn-primary btn-small" href="<?php echo get_site_url() ?>/feed/?post_type=advisories&platform=<?php echo $advisory_platform->slug  ?>" target="_blank">Follow <?php echo $advisory_platform->name; ?> advisories via RSS</a>
